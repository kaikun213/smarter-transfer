...
//		tester1 = new User(id+"@Tester1");
//		tester1.setTheme(new Theme(1));
//		tester2 = new User(id+"@Tester2");
//		tester2.setTheme(new Theme(1));
//
//		ApiResponse response = userResource.addUser(new UserDTO(tester1), id+"@Tester1", "EncPass@Tester1");
//		if (response.getStatus() != Status.OK) throw new Exception("" +response.getStatus() + response.getError().getDescription() + response.getError().getErrorCode());
