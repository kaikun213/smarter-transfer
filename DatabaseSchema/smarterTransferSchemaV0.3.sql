...
CREATE TABLE `MENU_ITEM` (
  ...
  `merchantId` bigint(20) NOT NULL,
  `itemId` bigint(20) NOT NULL,
  PRIMARY KEY (`menuId`,`merchantId`,`itemId`),
  KEY `fk_MENU_ITEM_1_idx` (`merchantId`),
  KEY `fk_MENU_ITEM_3_idx` (`merchantId`,`itemId`),
  CONSTRAINT `fk_MENU_ITEM_1` FOREIGN KEY (`menuId`, `merchantId`) REFERENCES `MENU` (`menuId`, `merchantId`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_MENU_ITEM_2` FOREIGN KEY (`merchantId`, `itemId`) REFERENCES `ITEM` (`merchantId`, `itemId`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_MENU_ITEM_3` FOREIGN KEY (`merchantId`) REFERENCES `MERCHANT` (`merchantId`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2017-01-13 13:28:38
